    ...
    <Container>
      ...
      <StepsContainer>
        ...
        <StepContainer>
          ...
          <StepDescription>Pick your best date to rent a car for you.</StepDescription>
        </StepContainer>
        <StepContainer>
          <Step>
            <StepIcon>
          ...
          <StepDescription>Book your very own car with ease in a single click.</StepDescription>
        </StepContainer>
      </StepsContainer>
    </Container>
  );
